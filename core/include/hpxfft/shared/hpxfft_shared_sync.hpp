...
namespace hpxfft::shared
{
    ...
    struct sync
    {
        ...
        private:
            ...
            // static wrappers
            static void fft_1d_r2c_inplace_wrapper(sync *th, 
                                                   const std::size_t i);
            static void fft_1d_c2c_inplace_wrapper(sync *th, 
                                                   const std::size_t i);
            static void transpose_shared_y_to_x_wrapper(sync *th, 
                                                        const std::size_t index);
            static void transpose_shared_x_to_y_wrapper(sync *th, 
