...
// wrappers
void hpxfft::shared::sync::fft_1d_r2c_inplace_wrapper(sync *th, const std::size_t i)
{
    th->fft_1d_r2c_inplace(i);
}

void hpxfft::shared::sync::fft_1d_c2c_inplace_wrapper(sync *th, const std::size_t i)
{
    th->fft_1d_c2c_inplace(i);
}

void hpxfft::shared::sync::transpose_shared_y_to_x_wrapper(sync *th, 
                                          const std::size_t index)
{
    th->transpose_shared_y_to_x(index);  
}

void hpxfft::shared::sync::transpose_shared_x_to_y_wrapper(sync *th, 
...
// initialization
void hpxfft::shared::sync::initialize(hpxfft::shared::vector_2d values_vec, 
...
// helpers
real hpxfft::shared::sync::get_measurement(std::string name)
{
