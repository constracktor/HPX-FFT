#include "../../include/hpxfft/shared/hpxfft_shared_opt.hpp"
...
// wrappers
void hpxfft::shared::opt::fft_1d_r2c_inplace_wrapper(opt *th, const std::size_t i)
{
    th->fft_1d_r2c_inplace(i);
}

void hpxfft::shared::opt::fft_1d_c2c_inplace_wrapper(opt *th, const std::size_t i)
{
    th->fft_1d_c2c_inplace(i);
}

void hpxfft::shared::opt::transpose_shared_y_to_x_wrapper(opt *th, 
                                          const std::size_t index)
{
    th->transpose_shared_y_to_x(index);  
}

void hpxfft::shared::opt::transpose_shared_x_to_y_wrapper(opt *th, 
...
// initialization
void hpxfft::shared::opt::initialize(hpxfft::shared::vector_2d values_vec, 
...
// helpers
real hpxfft::shared::opt::get_measurement(std::string name)
{
